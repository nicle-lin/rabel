...
HOST_MOUNT="/home/gubl//docker-mount/rabel"
IMAGE=${IMAGE:-niclelin/rabel:0.1}
PREFIX=${PREFIX:-niclelin}
...
start_mysql() {
   MYSQL_ID=$(docker run \
              ...
              --restart=always \
              --name mysql-rabel \
              -e MYSQL_ROOT_PASSWORD=dghpyss \
              -v $HOST_MOUNT:/var/lib/mysql \
	      mysql:latest)
}
